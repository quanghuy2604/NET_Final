        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(
                    ...
                    template: "subscribe-success",
                    defaults: new { controller = "TrangChus", action = "SubscribeSuccess" }
                );

                routes.MapRoute(
                    name: "updatesubscribersuccess",
                    template: "update-subscriber-success",
                    defaults: new { controller = "TrangChus", action = "UpdateSubscriberSuccess" }
                );
                ...
                routes.MapRoute(
                    name: "changeemail",
                    template: "manage-account/change-email",
                    defaults: new { controller = "ManageAccount", action = "ChangeEmail" }
                );
